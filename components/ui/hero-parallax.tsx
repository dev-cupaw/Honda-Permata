...
export const Header = ({ title, description }: { title: string; description: string }) => {
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full left-0 top-0">
      <h1 className="text-4xl md:text-7xl font-bold text-honda-gray-dark">{title}</h1>
      <p className="max-w-2xl text-base md:text-xl mt-8 text-honda-gray">{description}</p>
      <Button asChild variant="destructive" size="lg" className="mt-8 bg-honda-red-primary hover:bg-honda-red-dark">
        <Link href="/promo">Lihat Semua Promo</Link>
      </Button>
    </div>
  )
}
