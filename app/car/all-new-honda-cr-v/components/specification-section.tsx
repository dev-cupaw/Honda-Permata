...
const crvColors = [
  {
    ...
    code: "#F8F8FF",
    image: "/placeholder.svg?height=400&width=600&text=Platinum+White+Pearl+All+New+Honda+CR-V",
  },
  {
    name: "Crystal Black Pearl",
    code: "#000000",
    image: "/placeholder.svg?height=400&width=600&text=Crystal+Black+Pearl+All+New+Honda+CR-V",
  },
  {
    name: "Meteoroid Gray Metallic",
    code: "#708090",
    image: "/placeholder.svg?height=400&width=600&text=Meteoroid+Gray+Metallic+All+New+Honda+CR-V",
  },
  {
    name: "Ignite Red Metallic",
    code: "#B22222",
    image: "/placeholder.svg?height=400&width=600&text=Ignite+Red+Metallic+All+New+Honda+CR-V",
  },
  {
    name: "Canyon River Blue Metallic",
    code: "#4682B4",
    image: "/placeholder.svg?height=400&width=600&text=Canyon+River+Blue+Metallic+All+New+Honda+CR-V",
  },
]

const specifications = [
  { label: "Mesin", value: "1.5L VTEC Turbo DOHC / 2.0L e:HEV Hybrid" },
  { label: "Tenaga Maksimum", value: "190 PS (Turbo) / 184 PS (Hybrid Motor)" },
  { label: "Torsi Maksimum", value: "240 Nm (Turbo) / 315 Nm (Hybrid Motor)" },
  { label: "Transmisi", value: "CVT / e-CVT" },
  { label: "Sistem Penggerak", value: "Front Wheel Drive (FWD) / All Wheel Drive (AWD)" },
  { label: "Lampu Depan", value: "Full LED Headlights with Sequential Turning Signal" },
  { label: "Velg", value: '18" / 19" Alloy Wheels' },
  ...
  { label: "Suspensi Belakang", value: "Multi-Link" },
  { label: "Audio System", value: '9" Advanced Capacitive Touchscreen Display Audio' },
  { label: "Konektivitas", value: "Wireless Apple CarPlay & Android Auto" },
  { label: "AC", value: "Dual Zone Automatic Climate Control" },
  { label: "Kursi", value: "Leather-Trimmed Seats, Power Adjustable Driver Seat" },
  { label: "Keselamatan", value: "Honda SENSING 360" },
  { label: "Airbag", value: "8 Airbags" },
  { label: "Kamera", value: "Multi-View Camera System (MVCS)" },
  { label: "Fitur Lain", value: "Head-Up Display, Power Tailgate with Walk Away Close" },
]

export function SpecificationSection() {
  const [isColorModalOpen, setIsColorModalOpen] = useState(false)
  const [selectedColor, setSelectedColor] = useState(crvColors[0])
        ...
        <div className="max-w-6xl mx-auto">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="relative mb-8">
              <Image
                src="/placeholder.svg?height=400&width=600&text=All+New+Honda+CR-V+Side+Profile"
            ...
            >
              Rp 749.100.000 <ChevronRight className="h-5 w-5" />
            </Button>
              ...
              <div className="flex flex-col items-center justify-center flex-grow p-4 md:p-8 overflow-y-auto">
                <div className="relative w-full max-w-xl aspect-[3/2] mb-8">
                  <Image
                    ...
                    alt={`All New Honda CR-V - ${selectedColor.name}`}
                    fill
