...
const specifications = [
  { label: "Mesin", value: "1.5L VTEC Turbo DOHC 4-Cylinder" },
  { label: "Tenaga Maksimum", value: "178 PS @ 6,000 rpm" },
  { label: "Torsi Maksimum", value: "240 Nm @ 1,700-5,500 rpm" },
  { label: "Transmisi", value: "CVT with Paddle Shifters" },
  ...
  { label: "Mode Berkendara", value: "Normal, Sport, Eco" },
]
