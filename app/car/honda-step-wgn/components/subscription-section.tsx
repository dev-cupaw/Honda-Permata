      ...
      <div className="container mx-auto px-4 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-honda-red-light mb-8 text-lg">
            Dapatkan informasi terbaru tentang Honda STEP WGN e:HEV, promo menarik, dan berita otomotif lainnya langsung
            di inbox Anda.
          </p>
          {/* Button hover effect changed: background becomes red, text becomes white */}
          <Button
            size="lg"
