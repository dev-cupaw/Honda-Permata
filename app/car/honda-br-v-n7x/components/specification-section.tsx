...
const brvN7xColors = [
  {
    ...
    code: "#000000",
    image: "/placeholder.svg?height=400&width=600&text=Crystal+Black+Pearl+Honda+BR-V+N7X",
  },
  {
    name: "Premium Opal White Pearl",
    code: "#F8F8FF",
    image: "/placeholder.svg?height=400&width=600&text=Premium+Opal+White+Pearl+Honda+BR-V+N7X",
  },
  {
    name: "Meteoroid Gray Metallic",
    code: "#708090",
    image: "/placeholder.svg?height=400&width=600&text=Meteoroid+Gray+Metallic+Honda+BR-V+N7X",
  },
  {
    name: "Taffeta White",
    code: "#F8F8FF",
    image: "/placeholder.svg?height=400&width=600&text=Taffeta+White+Honda+BR-V+N7X",
  },
]
...
const specifications = [
  ...
  { label: "Velg", value: '17" Alloy Wheels' },
  ...
  { label: "Fitur Lain", value: "Remote Engine Start, Walk-Away Auto Lock" },
]

export function SpecificationSection() {
  const [isColorModalOpen, setIsColorModalOpen] = useState(false)
  const [selectedColor, setSelectedColor] = useState(brvN7xColors[0])
        ...
        <div className="max-w-6xl mx-auto">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="relative mb-8">
              <Image
                src="/placeholder.svg?height=400&width=600&text=Honda+BR-V+N7X+Side+Profile"
                alt="Honda BR-V N7X Edition"
                width={600}
                height={400}
            ...
            >
              Rp 363.400.000 <ChevronRight className="h-5 w-5" />
            </Button>
              ...
              <div className="flex flex-col items-center justify-center flex-grow p-4 md:p-8 overflow-y-auto">
                <div className="relative w-full max-w-xl aspect-[3/2] mb-8">
                  <Image
                    ...
                    alt={`Honda BR-V N7X Edition - ${selectedColor.name}`}
                    fill
                ...
                <div className="w-full max-w-md border-t border-honda-gray-light pt-6">
                  ...
                  <div className="grid grid-cols-2 gap-y-2 text-honda-gray-dark">
                    ...
                    <span>Honda BR-V N7X Edition</span>
