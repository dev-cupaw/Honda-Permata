...
export function BookingFormSection() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast.success("Permintaan test drive Anda telah terkirim! Kami akan segera menghubungi Anda.")
    setFormData({
      fullName: "",
      mobile: "",
      email: "",
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-3xl lg:text-4xl font-bold text-honda-gray-dark text-center mb-12">
            Jadwalkan Test Drive Honda e:N1
          </h2>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {/* Purchase Plan */}
              <div className="space-y-2">
                <Label className="text-sm font-medium text-honda-gray-dark">Pesan Tambahan</Label>
                <Textarea
                  ...
                  rows={3}
                  placeholder="Tuliskan pesan atau pertanyaan Anda (opsional)"
                />
              </div>
